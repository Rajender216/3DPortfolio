...
export default function Home() {
  return (
    <div id="home" className="min-h-screen bg-black pt-6 md:pt-36 flex flex-col-reverse md:flex-row items-center justify-center md:justify-between gap-6 md:gap-10 px-4 md:px-8 lg:px-16 border-b-4 border-teal-800">
